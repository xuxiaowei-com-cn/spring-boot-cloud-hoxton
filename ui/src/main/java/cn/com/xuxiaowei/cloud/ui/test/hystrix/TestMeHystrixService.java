...
public class TestMeHystrixService {
    ...
    public Map<String, Object> save(TestPassportMe testPassportMe) {
        return testMeService.save(testPassportMe);
    }

    /**
     * 测试 用户模块 参数接收、保存数据 异常数据
     *
     * @param testPassportMe 用户模块测试表
     * @return 返回 异常 结果
     * @throws TestMeException 测试用户模块 异常
     */
    public Map<String, Object> saveFallback(TestPassportMe testPassportMe) throws TestMeException {
