...
public class LoginRestController {
    ...
    public Map<String, Object> success(HttpServletRequest request, HttpServletResponse response) {
        ...
        map.put(MSG, "登录成功");
        data.put("url", "http://localhost:10401/oauth/authorize?client_id=xuxiaowei_client&redirect_uri=http://localhost:10401/oauth/auto/authorize&response_type=code&scope=snsapi_base&state=beff3dfc-bad8-40db-b25f-e5459e3d6ad7");
        return map;
    }
