package cn.com.xuxiaowei.cloud.passport.generator;
...
public class MyBatisPlusGenerator {
     ...
     * 自定义继承的Entity类全称，带包名
     */
    private String superEntityClass = Entity.class.getName();
    ...
    enum Datasource {
         ...
         * MySQL 数据库 hoxton
         */
        MYSQL_HOXTON("jdbc:mysql://127.0.0.1:3306/spring-boot-cloud-hoxton?useSSL=false&serverTimezone=GMT%2B8",
                "root", "root", "MySQL 数据库 hoxton"),
